...
@interface EditorViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UITextViewDelegate,BuildingViewControllerDelegate,UIAlertViewDelegate,UIActionSheetDelegate,MFMessageComposeViewControllerDelegate>
{
    UIToolbar *toolBar;
    MKMapView *mapView;
    UIView *view;//地图的视图
    BOOL BaoCun;//判断是否保存
    UITextField *companyTextField;//保存公司的名字
